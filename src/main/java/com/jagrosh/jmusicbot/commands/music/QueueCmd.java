...
public class QueueCmd extends MusicCommand 
{
    ...
    public QueueCmd(Bot bot)
    {
        super(bot);
        this.name = "queue";
        this.help = "Affiche la queue actuelle";
    ...
    public void doCommand(CommandEvent event)
    {
        ...
        if(list.isEmpty())
        {
            ...
            Message built = new MessageBuilder()
                    .setContent(event.getClient().getWarning() + " Il n'y a aucune commandes dans la queue!")
    ...
    private String getQueueTitle(AudioHandler ah, String success, int songslength, long total, boolean repeatmode)
    {
        ...
        return FormatUtil.filter(sb.append(success).append(" Queue Actuelle | ").append(songslength)
                .append(" entrées | `").append(FormatUtil.formatTime(total)).append("` ")
